// Test for shy_patches functionality in 3D
// Creates a simple 3D triangulation, distributes dofs, and creates shy patches
...
main()
{
  ...
  Step85::output_patches_vtk(block_list, dof_handler, level, "shy_patches_3d.vtk");
  ...
  std::ofstream output("user_flags_3d.vtk");
