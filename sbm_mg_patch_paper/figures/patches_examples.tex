...
\begin{tikzpicture}[scale=1.1,
    ...
    \begin{scope}[xshift=0.0cm]
        ...
        % marker (confident) at (1,1): small cross
    ...
    \begin{scope}[xshift=3.5cm]
        ...
        % marker (confident) at (1,1): small cross
        \draw[line width=2pt, gray, rounded corners=6pt, line join=round]  (0.15, 1.85 ) --(0.15,0.15) -- (1.85,0.15)  -- (1.85, 0.75)-- (2.15, 0.85) -- (2.15,2.15) -- (0.15,2.15) -- cycle;
    \end{scope}
    ...
    \begin{scope}[xshift=7.0cm]
        ...
        \draw[line width=2pt, gray, rounded corners=6pt, line join=round] (0.15,0.15) -- (1.9,0.15)-- (1.85, 0.75) -- (2.15, 0.9) -- (2.15,2.15) -- (0.85,2.15) -- (0.85,1.15) -- (0.15,1.15) -- cycle;
    \end{scope}
    ...
    \begin{scope}[xshift=10.5cm]
        ...
        \draw[line width=2pt, gray, rounded corners=6pt, line join=round] (-0.15, 0.9)--(0.15, 0.85) -- (0.15,0.15) -- (1.85,0.15) -- (1.85, 0.85)  -- (2.15, 0.9)--  (2.15,2.15)   -- (-0.15,2.15) -- cycle;
    \end{scope}
